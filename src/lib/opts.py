...
class opts(object):
  def __init__(self):
    ...
    # add by jerry
    self.parser.add_argument('--input-image', type=str, default='./data/1.jpg')
    # self.parser.add_argument('--img_width', type=int, default=1088)
    # self.parser.add_argument('--img_height', type=int, default=608)
